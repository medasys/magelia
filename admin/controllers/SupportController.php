...
include_once $_SERVER["DOCUMENT_ROOT"].'/medacloud/classes/Support.php';
...
class SupportController {
	...
	public function commercial() {
		if(isset($_SESSION['login'])) {
			...
			include $_SERVER["DOCUMENT_ROOT"].'/medacloud/customers/views/commercial-support.php';
		}
		else {
	...
	public function technical() {
		if(isset($_SESSION['login'])) {
			...
			include $_SERVER["DOCUMENT_ROOT"].'/medacloud/customers/views/technical-support.php';
		}
		else {
			header('Location: authentification.php');
		}
	...
	public function view() {
		if(isset($_SESSION['login'])) {
			...
			if( $_GET && !empty( $_GET['id'] ) ) {
				$_SESSION['license_id'] = $_GET['id'];
				$license = $this->license->getByIdByCustomer($_GET['id'], $_SESSION['login']);
			}				
			else
				$license = NULL;
			
			include $_SERVER["DOCUMENT_ROOT"].'/medacloud/customers/views/license-view.php';
		}
		else {
			header('Location: authentification.php');
		}
