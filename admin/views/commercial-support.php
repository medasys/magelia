...
<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="start active open">
					...
					<ul class="sub-menu">
						<li class="start active open"><a href="commercial-support.php"><i class="icon-arrow-right"></i>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<b>Support commercial</b> &nbsp;<small>Besoin d'informations? N'h&eacute;sitez pas &agrave; nous contacter</small>
			</h3>
			<div class="page-bar">
