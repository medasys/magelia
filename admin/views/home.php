		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<?php if(isset($_SESSION['login'])) { echo $_SESSION['login']; } ?></span>
...
<div class="page-container">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						<li><a href="reserve-domain.php"><i class="icon-arrow-right"></i>
						R&eacute;server un domaine</a></li>
						<li><a href="transfer-domain.php"><i class="icon-arrow-right"></i>
						...
						<li>
							...
							<ul class="sub-menu">
								<li><a href="domains.php"><i class="icon-arrow-right"></i>
								Domaine 1</a></li>
								<li><a href="domains.php"><i class="icon-arrow-right"></i>
								Domaine 2</a></li>
							</ul>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<b>Tableau de bord</b>&nbsp; <small>Toutes les statistiques sur les machines</small>
			</h3>
			<div class="page-bar">
