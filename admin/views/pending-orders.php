...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<b>Commandes en cours</b> &nbsp;<small>Informations sur mes commandes en cours de validation.</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-basket-loaded"></i>Liste des commandes en cours
							</div>
							<div class="actions">
								<div class="btn-group">
...
<!-- END FOOTER -->
<script src="../assets/admin/pages/scripts/pending-orders.js"></script>