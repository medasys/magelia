...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<b>Informations de la licence</b> &nbsp;<small>D&eacute;tails sur la licence s&eacute;lectionn&eacute;e</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="licenses.php">Gestion de licences</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-key"></i>Informations de la licence
							</div>
							<div class="actions">
								<a href="licenses.php" class="btn default yellow-stripe">
										...
										<div class="row">
											<div class="col-md-6 col-sm-12">
												<div class="portlet yellow box">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-cogs"></i>D&eacute;tails de la licence
														</div>
													</div>
													<div class="portlet-body">
														...
														<div class="row static-info">
															...
															<div class="col-md-7 value-data">
																 <?php echo date( "d/m/Y H:i:s" , strtotime( $license['activation_date'] ) ); ?>
															</div>
														</div>
														<div class="row static-info">
															<div class="col-md-5 name">
															...
															<div class="col-md-7 value-data">
																 <?php echo date( "d/m/Y H:i:s" , strtotime( $license['expire_date'] ) ); ?>
															</div>
														</div>
														<div class="row static-info">
															<div class="col-md-5 name">
														...
														<div class="row static-info">
															...
															<div class="col-md-7 value-data">
																<?php if($license['expire_date'] > date('Y-m-d')) { ?>
											...
											<div class="col-md-6 col-sm-12">
												<div class="portlet blue-madison box">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-cogs"></i>D&eacute;tails de la machine
														</div>
													</div>
													<div class="portlet-body">
														<div class="row static-info">
														...
														<div class="row static-info">
															...
															<div class="col-md-7 value-data">
																 <?php echo "Serveur virtuel priv&eacute;"; ?>
															</div>
														</div>
														<div class="row static-info">
															<div class="col-md-5 name">
