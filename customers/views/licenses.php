...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<b>Gestion de licences</b> &nbsp;<small>Vos informations sur les licences des syst&egrave;mes utilis&eacute;s</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-key"></i>Liste des licences des syst&egrave;mes
							</div>
							<div class="actions">
								<div class="btn-group">
							...
							<div class="table-container">
								<div class="table-actions-wrapper">
									...
									<select class="table-group-action-input form-control input-inline input-small input-sm">
										...
										<option value="Cancel">En cours</option>
										<option value="Cancel">Expir&eacute;e</option>
									</select>
									<button class="btn btn-sm yellow table-group-action-submit"><i class="fa fa-search"></i> Rechercher</button>
								</div>
								...
								<!-- <tr role="row" class="filter">
									...
									<td>
										<select name="order_status" class="form-control form-filter input-sm">
											...
											<option value="closed">Expir&eacute;e</option>
										</select>
									</td>
									<td>
										...
										<button class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i> Annuler</button>
									</td>
								</tr> -->
								</thead>
								<tbody>
...
<!-- END FOOTER -->
<script src="../assets/admin/pages/scripts/licenses.js"></script>