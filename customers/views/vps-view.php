...
<div class="page-container">
				...
				<li class="start active open">
					...
					<ul class="sub-menu">
						<?php foreach ($vpsList as $item) { ?>
							<?php if($vps['id'] == $item['id']) { ?>
								<li class="start active open"><a href="vps.php?action=view&id=<?php echo $item['id']; ?>"><i class="icon-drawer"></i>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<b><?php echo $vps['hostname']; ?></b> &nbsp;<small>Informations de votre serveur</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="vps.php?action=view&id=<?php echo $vps['id']; ?>"><?php echo $vps['hostname']; ?></a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-6 col-sm-6">
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-calendar"></i>Consommation de ressources
							</div>
							<div class="actions">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="easy-pie-chart">
										<div class="number transactions" data-percent=<?php echo $perCpu ?>>
											<span>
											<?php echo $perCpu ?></span>
											%
										</div>
										<a class="title" href="#">
										CPU cores <i class="icon-arrow-right"></i>
										</a>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="easy-pie-chart">
										<div class="number visits" data-percent=<?php echo $perMemory ?>>
											<span>
											<?php echo $perMemory ?> </span>
											%
										</div>
										<a class="title" href="#">
										M&eacute;moire RAM <i class="icon-arrow-right"></i>
										</a>
									</div>
								</div>
								<div class="margin-bottom-10 visible-sm">
								...
								<div class="col-md-4">
									<div class="easy-pie-chart">
										<div class="number bounce" data-percent=<?php echo $persDisk?>>
											<span>
											<?php echo $persDisk?></span>
											%
										</div>
										<span class="title">
										Disque dur <i class="icon-arrow-right"></i>
										</span>
									</div>
								</div>
							</div>
							<div class='alert alert-info note-info'><button class='close' data-close='alert'></button><span>Votre monitoring pour mieux g&eacute;rer votre machine.</span></div>
						</div>
					</div>
				</div>
				<div class="col-md-2 col-sm-2">
					<div id="vps-restart">
					<a class="dashboard-stat blue-madison link-functions" href="#" onclick="if(confirm('Attention, vous &ecirc;tes sur le point de r&eacute;d&eacute;marrer votre machine, voulez-vous continuer ?')) ajaxFormVmRestart( 'controllers/web/vpsAction.php', 'vmId=<?php echo $vps['id']; ?>&action=restart', 'vps-restart', 'note');return false;">
						<i class="icon-reload icon-functions"></i><br/>
						<span class="details-functions">Red&eacute;marrer ma machine</span>
					</a>
					</div>
				</div>
				<div class="col-md-2 col-sm-2">
					<div id="vps-password-reset">
					<a class="dashboard-stat blue-madison link-functions" href="#" onclick="if(confirm('Attention, vous &ecirc;tes sur le point de r&eacute;initialiser le mot de passe de votre machine, voulez-vous continuer ?')) ajaxFormVmPasswordReset( 'controllers/web/vpsAction.php', 'vmId=<?php echo $vps['id']; ?>&action=passwordReset', 'vps-password-reset', 'note');return false;">
						<i class="icon-lock icon-functions"></i><br/>
						<span class="details-functions">R&eacute;initialiser mot de passe</span>
					</a>
					</div>
				</div>
				<div class="col-md-2 col-sm-2">
					<a class="dashboard-stat blue-madison link-functions">
						<i class="icon-settings icon-functions"></i><br/>
						<span class="details-functions">R&eacute;initialiser ma machine</span>
					</a>
				</div>
				<div class="col-md-2 col-sm-2">
					<a class="dashboard-stat blue-madison link-functions">
						<i class="icon-cloud-upload icon-functions"></i><br/>
						<span class="details-functions">Augmenter mes ressources</span>
					</a>
				</div>
				<div class="col-md-2 col-sm-2">
					<a class="dashboard-stat blue-madison link-functions">
			...
			<div class="row ">
				<div class="col-md-6 col-sm-6">
					...
					<div class="portlet">
						...
						<small><?php echo date( "d/m/Y H:i:s" , strtotime( $vps['creation_date'] ) ); ?></small>
						</h3>
						<h3 class="page-title">
						<small><b>Date de renouvellement</b></small><br/>
						<small><?php if($vps['renewal_date'] != NULL) echo date( "d/m/Y H:i:s" , strtotime( $vps['renewal_date'] ) ); else echo 'N/A'; ?></small>
						</h3>
						<h3 class="page-title">
						<small><b>Nom de la machine</b></small><br/>
						<small><?php echo $vps['hostname']; ?></small>
						</h3>
						<h3 class="page-title">
						<small><b>IPv4</b></small><br/>
						<small><?php echo $vps['ip_addr']; ?></small>
						</h3>
						</div>
					</div>
