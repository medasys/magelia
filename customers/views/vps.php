...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Vps-test <small>Informations de votre serveur</small>
			</h3>
			<div class="page-bar">
			...
			<div class="row ">
				<div class="col-md-6 col-sm-6">
					<div class="portlet box yellow">
						...
						<div class="portlet-body">
							...
							<div class="note note-info monitoring-tab">
								Votre monitoring pour mieux g&eacute;rer votre machine.
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-2 col-sm-2">
					<a class="dashboard-stat blue-madison link-functions">
						...
						<span class="details-functions">R&eacute;initialiser mon mot de passe</span>
					</a>
				</div>
				<div class="col-md-2 col-sm-2">
					<a class="dashboard-stat blue-madison link-functions">
			...
			<div class="row ">
				<div class="col-md-6 col-sm-6">
					...
					<div class="portlet">
						...
						<small>vps-test</small>
						</h3>
						<h3 class="page-title">
						<small><b>IPv4</b></small><br/>
						<small>172.16.10.200</small>
						</h3>
						</div>
					</div>
