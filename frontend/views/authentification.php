	...
	<form class="login-form" action="authentification.php" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Entrez votre email" name="userEmail"/>
			</div>
		</div>
		<div class="form-group">
	...
	<form class="register-form" action="registration.php" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-envelope"></i>
				<input id="customerEmail" class="form-control placeholder-no-fix" type="text" placeholder="Entrez votre email" name="customerEmail" onchange="getUsername('customerEmail', 'userName'); return false;" />
			</div>
		</div>
		<p>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input id="userName" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Votre identifiant" name="userName" disabled />
			</div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Mot de passe</label>
