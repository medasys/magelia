    ...
    <div class="features-complements">
	  <div class="container">
    ...
    <div class="">
        ...
        <!-- END SERVICE BOX -->
        <!-- BEGIN SERVICE BOX -->
        <!-- BEGIN TABS AND TESTIMONIALS --><br/><br/><br/>
        <div class="container">
        <div class="row mix-block margin-bottom-40">
          <!-- TABS -->
          <div class="col-md-7 tab-style-1">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab-1" data-toggle="tab">Qui sommes-nous ?</a></li>
              <li><a href="#tab-2" data-toggle="tab">Nos services et m&eacute;tiers</a></li>
            </ul>
        ...
        <div class="row margin-bottom-40 our-clients">
          <div class="col-md-3">
            <h2><a href="#">Nos partenaires</a></h2>
