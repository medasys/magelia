    ...
    <div class="main">
      ...
      <!-- BEGIN SERVICE BOX -->   
        <div class="row service-box margin-bottom-40">
          <div class="col-md-12 col-sm-12">
            <div class="vps-text">Notre plateforme vous offre<br/> le plus stable des serveurs virtuels priv&eacute;s (VPS).</div>
            <p>D&eacute;terminez exactement la configuration voulue et cr&eacute;er votre serveur virtuel priv&eacute; avec une vitesse &eacute;poustouflante. L'offre VPS de Medacloud d&eacute;finit de nouveaux standards en termes de performance, s&eacute;curit&eacute; et qualit&eacute; de service.</p>
          </div>
      ...
      <div class="row vps-order margin-bottom-40">
        <div class="col-md-12 col-sm-12">
            ...
            <?php for($i = 0; $i < count($staticProducts); $i++) { ?>
        ...
        <div class="row mix-block margin-bottom-40">
          ...
          <div class="col-md-12 tab-style-1">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab-1" data-toggle="tab">Qu'est-ce-qu'un serveur virtuel priv&eacute;</a></li>
              <li><a href="#tab-2" data-toggle="tab">Les avantages que vous aviez</a></li>
            </ul>
