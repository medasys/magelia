    ...
    <div class="main">
      ...
      <div class="container">
	      <div class="col-md-3 col-sm-3">
	      	...
	      	<a href="vpsPayment.php" class="link-step"><div class="order-step"><i class="icon-credit-card"></i> &nbsp;Paiement
	      	<div class="order-step-info">Les modalit&eacute;s de paiement pour effectuer votre commande.</div>
	      	</div></a>
	      	<a href="vpsValidation.php" class="link-step"><div class="order-step-selected"><i class="icon-check"></i> &nbsp;Validation
	      ...
	      <div class="col-md-9 col-sm-9">
		      ...
		      <span class="payment-title"><i class="icon-book-open"></i> Rubrique VPS : <?php echo $vmName; ?></span>
		      <table class="invoice-table">
		        ...
		        <tbody>
		          <tr>
		          	<td>Serveur virtuel priv&eacute; de type <?php echo $staticProduct['type']; ?> - <?php echo $vmSubscription; ?> mois</td>
		            <td>1</td>
		            <td><?php echo $staticProduct['ht_total']*$vmSubscription; ?> DH</td>
		            <td><?php echo $staticProduct['ht_total']*$vmSubscription; ?> DH</td>
		          </tr>
		          <tr>
		          	<td><?php echo $version['name']; ?> - <?php echo $vmSubscription; ?> mois</td>
		            <td>1</td>
		          ...
		          <tr>
		            ...
		            <td></td>
		            <td><b>Total HT</b></td>
		            <td><b><?php echo ($staticProduct['ht_total']+$version['ht_total'])*$vmSubscription; ?> DH</b></td>
		          </tr>
		          <tr>
		          	<td></td>
		            <td></td>
		            <td><b>TVA (20 %)</b></td>
		            <td><b><?php echo ($staticProduct['ht_total']+$version['ht_total'])*$vmSubscription*0.2; ?> DH</b></td>
		          </tr>
		          <tr>
		          	<td></td>
		            <td></td>
		            <td><b>Total TTC</b></td>
		            <td><b><?php echo ($staticProduct['ht_total']+$version['ht_total'])*$vmSubscription*1.2; ?> DH</b></td>
		          </tr>
		        </tbody>
		      </table><br/>
	...
	<div id="command" class="command">
		<img class="order-footer" src="../assets/frontend/layout/img/order-header.jpg" />
		<div class="print-separator"></div><br/><br/><br/><br/>
		<div class="">
			...
			Expiration : <b><?php echo date( "d/m/Y H:i:s" , strtotime( $orderline['expire_command_date'] ) ); ?></b><br/>
		</div>
