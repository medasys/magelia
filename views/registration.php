    ...
    <div class="main">
      ...
      <div class="container">
      	<div class="col-md-3 col-sm-3">
	      	...
	      	<div class="order-step"><i class="icon-basket-loaded"></i> &nbsp;Commande
	      	<div class="order-step-info">Choisissez une des offres disponibles selon vos besoins.</div>
	      	</div>
	      	<div class="order-step"><i class="icon-settings"></i> &nbsp;Configuration
      ...
      <i class="icon-envelope-letter mail-sent"></i><br/><br/>
	  <h3>Votre compte a &eacute;t&eacute; cr&eacute;&eacute; avec succ&egrave;s</h3>
	  <p>Une confirmation vous a &eacute;t&eacute; envoy&eacute;e &agrave; l'adresse email que vous nous avez fourni (<?php echo $customerEmail; ?>).<br/>
		Cliquez sur le lien d'activation dans le message pour terminer la cr&eacute;ation de votre compte et passer &agrave; la commande de votre machine.
	  </p>
	  <p><b>Si vous ne le faites pas, ce compte sera effac&eacute; automatiquement dans quelques jours.</b></p>
	  <p><a href="registration.php?id=<?php echo $customerId; ?>&action=activate">Cliquez sur ce lien pour activer votre compte Medacloud</a></p>
	  </div>
