    ...
    <div class="main">
      <div class="row quote-v1 margin-bottom-30 breadory-body">
          <div class="container">
          <div class="col-md-9">
            <span>Votre configuration de serveur virtuel priv&eacute;</span>
          </div>
      ...
      <div class="container">
	      <div class="col-md-3 col-sm-3">
	      	...
	      	<a href="vpsOrder.php?product_id=<?php echo $staticProduct['id']; ?>" class="link-step"><div class="order-step"><i class="icon-basket-loaded"></i> &nbsp;Commande
	      	<div class="order-step-info">Choisissez une des offres disponibles selon vos besoins.</div>
	      	</div></a>
	      	<a href="vpsConfigure.php?product_id=<?php echo $staticProduct['id']; ?>" class="link-step"><div class="order-step-selected"><i class="icon-settings"></i> &nbsp;Configuration
	      ...
	      <div class="col-md-6 col-sm-6">
		      <form class="login-form" action="vpsPayment.php" method="post">
				...
				<h3 class="form-title">Choisissez votre syst&egrave;me d'exploitation</h3>
				<div class="form-group">
                    <select id="osId" class="form-control" name="osId" onchange="ajaxSelect( 'controllers/web/osAction.php' , 'osId='+document.getElementById('osId').value+'&action=selectVersions', 'versionId' ); return false;">
                      <option value="" selected>Choisir mon syst&egrave;me d'exploitation</option>
                      <?php for($i = 0; $i < count($osData); $i++) { ?>
					  <option value="<?php echo $osData[$i]['id']; ?>"><?php echo $osData[$i]['name']; ?></option>
					  <?php } ?>
                    </select>
                </div>
                <div class="form-group input-bottom">
                    <select id="versionId" class="form-control" name="versionId" onchange="ajaxSelectTotal( 'controllers/web/osAction.php' , 'versionId='+document.getElementById('versionId').value+'&action=selectTotalVersion', 'totalHidden' ); return false;">
                      <option value="" selected>Choisir une version</option>
                    </select>
                    <input id="totalHidden" type="hidden" value="" />
                </div>
				...
				<div class="form-actions">
					<input type="hidden" name="productId" value="<?php echo $staticProduct['id']; ?>" />
					<button type="submit" class="btn yellow pull-right">
					Valider <i class="m-icon-swapright m-icon-white"></i>
					</button>
				</div>
				<div class="form-group input-bottom"><br/><br/></div>
			</form>
	      <!-- <h3 class="form-title">Ce que vous pouvez faire avec votre serveur</h3><br/>
	      <div class="col-md-4 col-sm-4">
	      <center><img src="assets/frontend/layout/img/web.png" width="80" /><br/><span class="vps-services"><b>Site web</b></span><br/><div class="services-desc">D&eacute;ployez votre site web dans votre serveur et r&eacute;alisez des &eacute;conomies en maintenant un service de qualit&eacute;.</div></center>
	      </div>
	      <div class="col-md-4 col-sm-4">
	      <center><img src="assets/frontend/layout/img/shopping.png" width="80" /><br/><span class="vps-services"><b>E-commerce</b></span><br/><div class="services-desc">B&eacute;n&eacute;ficiez d'un h&eacute;bergement adapt&eacute; &agrave; votre boutique e-commerce.</div></center>
	      </div>
	      <div class="col-md-4 col-sm-4">
	      <center><img src="assets/frontend/layout/img/console.png" width="80" /><br/><span class="vps-services"><b>D&eacute;veloppement</b></span><br/><div class="services-desc">Installez tous les outils et applications n&eacute;cessaires au d&eacute;veloppement dans votre serveur.</div></center>
	      </div>
	      <div class="col-md-4 col-sm-4">
	      <br/>
	      </div> -->
	      ...
	      <h3 class="order-title"><b>Votre commande</b></h3>
              <div class="price-availability-block clearfix">
              	<div class="price">
                	<span class="order-item-price">Total HT : </span><strong><span id="totalPrice" class="totalPrice"><?php echo $staticProduct['ht_total']; ?></span> <span>DHS<span class="total_unity">/Mois</span></span></strong>
                </div>
              </div>
              ...
              <div id="os-block" class="os-block"></div>
              <div id="order-item-price-small-os" class="order-item-price-small-os"></div>
